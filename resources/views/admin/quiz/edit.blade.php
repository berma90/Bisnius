...
@section('content')
    ...
    <p class="mt-2 text-xl font-bold text-white">Edit Quiz</p>
        ...
        <div class="mt-4 w-full border-collapse bg-netral50 rounded-lg overflow-hidden h-[550px] relative">
            <div class="m-8">
                <div>
                    ...
                    <input type="text" name="judul" class="w-full p-2 border rounded-md bg-transparent" value="{{ $quiz->judul }}" required>
                </div>
                <div class="mt-4">
                    ...
                    <select name="fk_cover" class="w-full p-2 border rounded-md bg-transparent" required>
                        ...
                        <option value="{{ $cover->id }}" {{ $quiz->fk_cover == $cover->id ? 'selected' : '' }}>{{ $cover->judul }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="mt-4">
                    ...
                    <select name="fk_mentor" class="w-full p-2 border rounded-md bg-transparent" required>
                        ...
                        <option value="{{ $mentor->id }}" {{ $quiz->fk_mentor == $mentor->id ? 'selected' : '' }}>{{ $mentor->nama_mentor }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
